...
export function HowItWorksSection() {
  return (
    <ScrollReveal
      as="section"
      className="bg-[#f5ebe0] px-5 py-16 sm:px-8 sm:py-20"
      id="how-it-works"
    >
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-center lg:gap-16">
        <div>
          <p className="text-[11px] font-normal uppercase tracking-[0.32em] text-[#c79c66]">
            Why it Works
          </p>
          <h2 className="mt-3 max-w-[16rem] text-[2rem] leading-[1.12] tracking-[-0.03em] text-[#1c133b] sm:text-[2.35rem]">
            <span className="font-normal">Simple on the surface.</span>
            <span className="mt-1 block font-bold">Serious underneath.</span>
          </h2>
          <p className="mt-5 max-w-[18rem] text-[13px] font-light leading-7 text-[#1c133b]/80">
        ...
        <div className="grid gap-10 sm:grid-cols-3 sm:gap-0">
          {steps.map((step, index) => (
            ...
            >
              ...
              <p className="mt-2 text-[12px] font-light leading-[1.45] text-[#1c133b]/75">
                {step.description}
              </p>
            </div>
          ))}
